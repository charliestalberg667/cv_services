      ...
      cards: [
        {
          ...
          text: `1.1 La durée de validité des offres est indiquée dans celles-ci. Sauf indication contraire, les offres sont exprimées en euros (EUR) et la durée de validité est de 1 (un) mois. CV SERVICES est cependant libre de retirer son offre jusqu'à ce qu'elle soit acceptée par le Client.
          1.2 Toute commande d'un Client engage ce dernier par l'envoi de sa commande. L'organisation interne du Client ne peut être opposée à CV SERVICES et les employés, représentants, agents ou intermédiaires du Client sont irréfutablement réputés disposer du pouvoir requis pour engager le Client envers CV SERVICES. Inversement, les employés, représentants, agents et intermédiaires de CV SERVICES n'ont pas le pouvoir d'engager CV SERVICES. Les engagements pris par les agents, distributeurs ou représentants de CV SERVICES ne deviennent définitifs qu'après acceptation par CV SERVICES.
          1.3 CV SERVICES se réserve le droit de corriger à tout moment et en toutes circonstances les erreurs dans les confirmations de commande qui pourraient être faites dans les offres, de quelque nature que ce soit (prix, délai, etc.). CV SERVICES a également la possibilité de modifier à tout moment les conditions de la commande (y compris le calendrier) que le Client accepte, tant que cela ne perturbe pas le contrat.
          1.4 Pour une commande de produits sur mesure ou hors plan, CV SERVICES établit l'offre sur la base des dimensions communiquées par le Client. Ce dernier est entièrement responsable de l'exactitude des mesures communiquées et est responsable de vérifier la transcription correcte de ces mesures sur le bon de commande.
          1.5 Si la commande a été passée en ligne (via la boutique en ligne), l'utilisateur a le droit d'annuler son achat, sans donner de raison et sans frais, dans les 14 jours calendaires suivant le jour suivant la livraison. Pendant ces 14 jours, le consommateur doit informer CV SERVICES de son intention de se rétracter, en indiquant l'article qu'il souhaite retourner, en mentionnant le prix et le numéro de référence. Le numéro de commande et la date de livraison y sont également mentionnés. L'équipe e-commerce organisera immédiatement le retour de l'article à une date convenue entre les parties. CV SERVICES remboursera intégralement le montant de l'article, à condition que les marchandises soient complètes, en parfait état, non utilisées et dans leur emballage d'origine. Les frais de transport ne sont en aucun cas remboursés au consommateur, même si la commande est retournée dans son intégralité. Et les frais inhérents à ce retour sont à sa charge. Dès que l'article est en possession de CV SERVICES, le remboursement a lieu.
          ...
          Malgré tous les soins apportés à la mise en ligne de notre gamme de produits, le site www.solarstock.be n'est pas à l'abri de la présence de contenu erroné lié à des informations écrites confuses, incomplètes, inexactes ou incorrectes. Le site peut également être soumis à des pannes techniques de temps à autre. Dès qu'elle en a connaissance, CV SERVICES met tout en œuvre pour remédier à ces lacunes dans les plus brefs délais. L'entreprise CV SERVICES décline toute responsabilité pour les dommages directs ou indirects, de nature matérielle ou immatérielle, causés par son site et les sites associés. Qu'il s'agisse de prix, d'images ou de textes, les erreurs mentionnées sur le site ne donnent pas au client le droit d'annuler le paiement d'un produit ou de réclamer une quelconque indemnisation. Pour tout litige du client, CV SERVICES, avec la plus grande objectivité possible et en conservant un esprit commercial, proposera la solution qu'elle juge appropriée.
          1.7 CV SERVICES honore toutes les commandes dans la limite des stocks disponibles.`
        },
        {
          title: "Article 2: Prix",
          text: `2.1 Sauf indication contraire, les prix sont soit hors TVA pour les professionnels, soit TVA incluse pour les particuliers, au taux en vigueur le jour de la commande. Toute modification du taux peut être répercutée sur le prix des marchandises. Si CV SERVICES prend en charge le transport ou son organisation, CV SERVICES facturera également au Client les frais de transport, que ce dernier accepte. L'emballage adapté au mode de transport est également facturé.
          2.2 CV SERVICES se réserve le droit d'ajuster le montant de ses factures en fonction de l'augmentation des coûts de production ou d'achat/livraison que CV SERVICES pourrait avoir subis, entre la date d'envoi de la confirmation de commande et la date de livraison effective des produits/biens.`
        },
        {
          ...
          3.2 Un litige concernant nos services fournis et/ou les biens livrés ne peut être un motif de non-paiement ou de non-paiement des factures de CV SERVICES.
          ...
          3.6 En cas de non-paiement à l'échéance, CV SERVICES se réserve le droit de suspendre l'exécution du présent contrat, ainsi que toute autre commande, en tout ou en partie, jusqu'au jour du paiement intégral par le Client des factures, même si elles ne sont pas exigibles, majorées des intérêts contractuels et de l'indemnité.
          3.7 Enfin, toute demande de réorganisation ou de liquidation judiciaire, de médiation de dettes, de sursis de paiement ou tout autre fait pouvant impliquer ou laisser présumer l'insolvabilité du Client, entraîne automatiquement la perte par le Client sans préavis de toutes les factures en cours. De plus, ces situations donnent à CV SERVICES le droit de suspendre toutes les obligations de CV SERVICES sans formalité préalable et de résilier les contrats en cours en tout ou en partie sans autre formalité que la notification par lettre recommandée ou e-mail.
          3.8 Les frais administratifs, techniques ou autres liés au retard de paiement sont entièrement à la charge du Client.
          3.9 Toute réclamation concernant une facture doit être envoyée au plus tard huit jours calendaires après réception, soit par e-mail : info@cvservices.be ; soit par courrier recommandé : CV SERVICES, Bergensesteenweg 458 à 1600 Sint-Pieters-Leeuw.`
        },
        {
          ...
          4.3 Il appartient au Client de faire, à la réception des produits/biens, toutes réserves utiles de manière claire et précise au transporteur (sur le bon de livraison), sous peine de déchéance. CV SERVICES ne peut en aucun cas être tenue responsable des incidents ou dommages liés au transport.
          4.4 Le Client s'engage à vérifier à la réception la qualité et la quantité des produits/biens et leur conformité à la commande. Toute réclamation concernant les biens est considérée comme nulle si elle n'est pas formulée par écrit dans les 48 heures suivant la livraison (soit par e-mail : info@cvservices.be ; soit par courrier ordinaire : CV SERVICES, Bergensesteenweg 458 à 1600 Sint-Pieters-Leeuw). À défaut, l'acheteur ne pourra plus invoquer ce(s) défaut(s).
          4.5 Sauf accord contraire, la livraison est effectuée "franco usine/entrepôt à l'endroit désigné par CV SERVICES.`
        },
        {
          title: "Article 5: Garantie",
          text: `5.1 CV SERVICES fournit au Client des biens conformes au contrat. En cas de défaut de conformité, le Client non professionnel dispose d'une garantie légale de deux (2) ans, lui permettant de déposer une réclamation auprès du service client de CV SERVICES dans les huit (8) jours suivant la découverte ou la date à laquelle le Client ne pouvait raisonnablement pas en avoir connaissance. Le Client non professionnel qui souhaite bénéficier de la garantie légale doit présenter la facture ou le justificatif d'achat original.
          ...
          5.3 Lorsque la garantie offerte par CV SERVICES est supérieure à deux (2) ans, sa durée est indiquée dans les caractéristiques du produit.`
        },
        {
          title: "Article 6: Limitation de responsabilité",
          text: `6.1 La responsabilité de CV SERVICES est expressément limitée à la réparation des dommages directs résultant exclusivement de sa faute grave et intentionnelle ou de celle de l'un de ses employés.
          6.2 La responsabilité de CV SERVICES est expressément exclue en cas de faute grave, non intentionnelle et même de faute(s) légère(s) répétée(s), sans que cette énumération soit exhaustive.
          6.3 Dans tous les cas, la responsabilité de CV SERVICES est exclusivement limitée au remplacement ou à la réparation de la conformité des biens.
          ...
          6.5 CV SERVICES décline toute responsabilité en cas de dommages aux personnes, aux biens ou au produit vendu, causés par le montage, le stockage ou toute autre cause, même inconnue.
          6.6 En cas de défaut spécifique au produit livré, le Client doit en informer immédiatement CV SERVICES.`
        },
        {
          title: "Article 7: Réserve de propriété",
          text: `7.1 Les biens livrés restent la propriété entière de CV SERVICES jusqu'au paiement intégral du prix, même en cas de transformation ou de traitement de ces produits en d'autres biens. Jusqu'à ce moment, CV SERVICES peut en disposer librement et entièrement. Inversement, le Client, tant que le paiement n'a pas été intégralement effectué, ne peut disposer des biens, les transformer, les aliéner, les transmettre, les graver et/ou les mettre à la disposition d'un tiers sous quelque titre que ce soit. Cette réserve de propriété s'applique également en cas de faillite, de réorganisation ou de liquidation judiciaire.
        ...
        },
        {
          ...
          text: `CV SERVICES se conforme à la législation belge édictée par les Régions concernant les équipements électriques et électroniques usagés (EEE). Pour ce faire, le prix des produits et biens n'inclut pas les coûts de collecte et de traitement des équipements électriques et électroniques usagés, qui s'ajoutent au prix. Le Client est invité à contacter CV SERVICES pour en savoir plus sur les méthodes de collecte et de traitement de ses équipements électriques et électroniques usagés.`
        },
        {
          title: "Article 9: Confidentialité",
          text: `9.1 CV SERVICES traite les données personnelles pour la gestion de son fichier clients, pour l'exécution de programmes de fidélité, ainsi que pour la promotion de ses produits, conformément à la législation sur la protection des données et, plus spécifiquement, au Règlement Général sur la Protection des Données (RGPD) et à la loi du 30 juillet 2018 relative à la protection des personnes physiques à l'égard du traitement des données à caractère personnel. CV SERVICES est le responsable du traitement au sens du RGPD. Les données sont traitées soit sur la base de l'exécution du contrat entre CV SERVICES et le Client, soit sur la base de ses obligations légales, notamment en matière comptable. Les données sont traitées pour une période ne dépassant pas celle nécessaire pour atteindre les finalités susmentionnées. En tout état de cause, elles sont supprimées après une période de 7 ans à compter de la fin de la relation contractuelle.
          9.2 Dès que ses données personnelles sont traitées, le Client dispose de droits : le droit d'accès aux données traitées et de les corriger si nécessaire, le droit de limitation du traitement, le droit à l'effacement des données et le droit à la portabilité des données. Toute demande relative à l'exercice de l'un ou plusieurs de ces droits doit être adressée à CV SERVICES (soit par e-mail : info@cvservices.be ; soit par courrier ordinaire : CV SERVICES, Bergensesteenweg 458 à 1600 Sint-Pieters-Leeuw).
        ...
        },
        {
          ...
          text: `Le site www.solarstock.be et tous les éléments sous-jacents, à l'exception de certains (hyper)liens menant à des sites Web en dehors du domaine de CV SERVICES, sont la propriété de l'entreprise CV SERVICES. Les photos, illustrations, acronymes, logos, ainsi que les descriptions et fiches produits, ou tout autre contenu apparaissant sur le site, sont protégés par des droits d'auteur/propriété intellectuelle. Toute reproduction ou représentation, totale ou partielle, du site ou de l'un de ses éléments sur quelque support ou de quelque manière que ce soit est interdite. Le non-respect de cette interdiction constitue le délit de contrefaçon et est passible de poursuites civiles et pénales.`
        },
        {
          title: "Article 11: Force majeure",
          text: `CV SERVICES se réserve le droit d'annuler les commandes, sans indemnité, si un cas de force majeure empêche leur exécution normale. Par accord exprès, les grèves, le manque de transport, l'incendie, l'inondation, les dommages aux équipements, les émeutes, la guerre, l'épidémie, l'accident, que ce soit chez CV SERVICES ou chez l'un de ses fournisseurs, seront considérés comme des cas de force majeure, même s'ils ne sont que partiels, et quelle qu'en soit la cause. Cette liste n'est pas exhaustive. Ne sera pas considéré comme un cas de force majeure : l'impossibilité financière pour le Client de payer CV SERVICES.`
        },
        {
          title: "Article 12: Réclamations et litiges",
          text: `12.1 En cas de réclamation, celle-ci doit être envoyée par e-mail à l'adresse suivante : info@cvservices.be. Pour toute réclamation d'un acheteur, CV SERVICES, avec la plus grande objectivité possible et en conservant un esprit commercial, proposera la solution qu'elle juge appropriée. En cas de désaccord entre CV SERVICES et un Consommateur, seuls les tribunaux de Bruxelles sont compétents, sans préjudice des dispositions du Code judiciaire applicables en cas de litige entre CV SERVICES et un Consommateur. Le droit belge s'applique à ces conditions générales.
      ...
      cards: [
        {
          ...
          text: `1.1 De geldigheidsduur van de aanbiedingen staat daarin vermeld. Tenzij anders vermeld, zijn aanbiedingen uitgedrukt in euro's (EUR) en bedraagt de geldigheidsduur 1 (één) maand. CV SERVICES is echter vrij haar aanbod in te trekken totdat het door de Klant is aanvaard.
          1.2 Elke bestelling van een Klant bindt laatstgenoemde door de enkele verzending van zijn bestelling. De interne organisatie van de Klant kan niet aan CV SERVICES worden tegengeworpen en de werknemers, vertegenwoordigers, agenten of tussenpersonen van de Klant worden onweerlegbaar geacht over de vereiste volmacht te beschikken om de Klant aan CV SERVICES te binden. Omgekeerd hebben de werknemers, vertegenwoordigers, agenten en tussenpersonen van CV SERVICES geen bevoegdheid om CV SERVICES te binden. Toezeggingen gedaan door agenten, distributeurs of vertegenwoordigers van CV SERVICES worden pas definitief na aanvaarding door CV SERVICES.
          1.3 CV SERVICES behoudt zich te allen tijde en onder alle omstandigheden het recht voor om fouten in de orderbevestigingen die eventueel in de aanbiedingen zijn gemaakt, van welke aard dan ook (prijs, termijn etc.) te corrigeren. CV SERVICES heeft ook de mogelijkheid om op elk moment de voorwaarden van de bestelling (inclusief het schema) die de Klant aanvaardt te wijzigen, zolang dit het contract niet verstoort.
          1.4 Bij een bestelling van maatwerk of off-plan producten stelt CV SERVICES de offerte op op basis van de door de Klant meegedeelde afmetingen. Deze laatste is volledig verantwoordelijk voor de juistheid van de meegedeelde metingen en is verantwoordelijk voor het controleren van de correcte transcriptie van deze metingen op de bestelbon.
          1.5 Indien de bestelling online (via de webshop) werd geplaatst, heeft de gebruiker het recht om zijn aankoop, zonder opgave van reden en zonder bijbetaling, te annuleren binnen 14 kalenderdagen vanaf de dag die volgt op de levering. Tijdens deze 14 dagen moet de consument CV SERVICES op de hoogte stellen van zijn voornemen om te herroepen, met vermelding van het artikel dat hij wil retourneren, met vermelding van de prijs en het referentienummer. Hierop worden ook het bestelnummer en de leverdatum vermeld. Het e-commerceteam zal onmiddellijk de retourzending van het artikel regelen op een tussen de partijen overeengekomen datum. CV SERVICES zal het bedrag van het artikel volledig terugbetalen, op voorwaarde dat de goederen compleet, in perfecte staat, ongebruikt en in de originele verpakking zijn. Transportkosten worden op geen enkele wijze aan de consument vergoed, ook niet als de bestelling in zijn geheel wordt geretourneerd. En de kosten die inherent zijn aan deze retourzending zijn voor zijn rekening. Zodra het artikel in het bezit is van CV SERVICES, vindt de terugbetaling plaats.
          ...
          Ondanks alle zorg die wordt besteed aan het online zetten van ons assortiment producten, is de site www.solarstock.be niet immuun voor de aanwezigheid van foutieve inhoud die verband houdt met verwarrende, onvolledige, onnauwkeurige of onjuiste geschreven informatie. Ook kan de site af en toe onderhevig zijn aan technische storingen. Zodra zij hiervan kennis krijgt, stelt CV SERVICES alles in het werk om deze tekortkomingen zo snel mogelijk te verhelpen. Het bedrijf CV SERVICES wijst elke aansprakelijkheid af voor directe of indirecte schade, van materiële of immateriële aard, veroorzaakt door haar site en aanverwante websites. Of het nu gaat om prijs, beeldmateriaal of teksten, fouten die op de site worden vermeld, geven de koper niet het recht om de betaling voor een product te annuleren of enige schadevergoeding te eisen. Voor elk geschil van de koper zal CV SERVICES, met de grootst mogelijke objectiviteit en met behoud van commerciële geest, de oplossing bieden die zij passend acht.
          1.7 CV SERVICES honoreert alle bestellingen binnen de grenzen van de beschikbare voorraden.`
        },
        {
          title: "Artikel 2: Prijs",
          text: `2.1 Tenzij anders bepaald, zijn de prijzen ofwel exclusief BTW voor professionelen, ofwel inclusief BTW en BTW voor particulieren, tegen het tarief dat geldt op de dag van de bestelling. Elke wijziging in het tarief kan worden weerspiegeld in de prijs van de goederen. Indien CV SERVICES het transport of de organisatie ervan verzorgt, zal CV SERVICES de Klant bovendien de transportkosten factureren, die deze laatste aanvaardt. Ook verpakking passend bij de wijze van transport wordt in rekening gebracht.
          2.2 CV SERVICES behoudt zich het recht voor om het bedrag van haar facturen aan te passen aan de stijging van de productie- of inkoop-/leveringskosten die CV SERVICES mogelijk heeft geleden, tussen de datum van verzending van de orderbevestiging en de datum van effectieve levering van producten/goederen.`
        },
        {
          ...
          3.2 Een geschil met betrekking tot onze geleverde diensten en/of geleverde goederen kan geen reden zijn voor niet-tijdige betaling of niet-betaling van facturen van CV SERVICES.
          ...
          3.9 Elke klacht met betrekking tot een factuur moet uiterlijk acht kalenderdagen na ontvangst worden verzonden, hetzij per e-mail: info@cvservices.be; of per aangetekende post: CV SERVICES, Bergensesteenweg 458 te 1600 Sint-Pieters-Leeuw.`
        },
        {
          ...
          4.3 Het is aan de Klant om bij ontvangst van de producten/goederen op duidelijke en nauwkeurige wijze eventuele nuttige voorbehouden te maken aan de vervoerder (op de leveringsbon), op straffe van verval. CV SERVICES kan in geen geval aansprakelijk worden gesteld voor incidenten of schade verbonden aan het transport.
          4.4 De Klant verbindt zich ertoe de producten/goederen bij ontvangst te controleren op kwaliteit en kwantiteit en op hun conformiteit met de bestelling. Elke klacht met betrekking tot de goederen wordt als nietig beschouwd als deze niet binnen de 48 uur schriftelijk (hetzij per e-mail: info@cvservices.be; hetzij per gewone post: CV SERVICES, Bergensesteenweg 458 te 1600 Sint-Pieters-Leeuw) wordt ingediend na levering. Bij gebreke daarvan kan de koper geen beroep meer doen op deze gebrek(en).
          4.5 Tenzij anders overeengekomen geschiedt levering "franco af fabriek/magazijn op de door CV SERVICES aangewezen plaats.`
        },
        {
          title: "Artikel 5: Garantie",
          text: `5.1 CV SERVICES levert aan de Klant goederen die beantwoorden aan de overeenkomst. In geval van gebrek aan overeenstemming beschikt de niet-professionele Klant over een wettelijke garantie van twee (2) jaar, waardoor hij binnen acht (8) dagen na ontdekking een klacht kan indienen bij de klantenservice van CV SERVICES of de datum waarop de Klant er redelijkerwijs niet van op de hoogte kon zijn. De niet-professionele Klant die van de wettelijke garantie wil genieten, overlegt daartoe de factuur of het originele aankoopbewijs.
          ...
          5.3 Wanneer de door CV SERVICES geboden garantie langer is dan twee (2) jaar, wordt de duur ervan aangegeven bij de producteigenschappen.`
        },
        {
          title: "Artikel 6: Beperking van aansprakelijkheid",
          text: `6.1 De aansprakelijkheid van CV SERVICES is uitdrukkelijk beperkt tot het herstel van directe schade die uitsluitend voortvloeit uit haar grove en opzettelijke fout of die van een van haar medewerkers.
          6.2 De aansprakelijkheid van CV SERVICES wordt uitdrukkelijk uitgesloten in geval van ernstige, onbedoelde fout en zelfs herhaalde lichte fout(en), zonder dat deze opsomming uitputtend is.
          6.3 In alle gevallen is de aansprakelijkheid van CV SERVICES uitsluitend beperkt tot de vervanging of het herstel van de conformiteit van de goederen.
          ...
          6.5 CV SERVICES wijst elke aansprakelijkheid af in geval van schade aan personen, eigendommen of het verkochte product, veroorzaakt door montage, opslag of elke andere oorzaak, ook al is deze onbekend.
          6.6 Indien zich een gebrek voordoet dat specifiek is aan het geleverde product, dient de Klant CV SERVICES onmiddellijk op de hoogte te stellen.`
        },
        {
          title: "Artikel 7: Eigendomsvoorbehoud",
          text: `7.1 De geleverde goederen blijven de volledige eigendom van CV SERVICES tot de volledige betaling van de prijs, zelfs in geval van transformatie of verwerking van deze producten in andere goederen. Tot dat moment kan CV SERVICES er vrij en volledig over beschikken. Omgekeerd mag de Klant, zolang de betaling niet volledig heeft plaatsgevonden, niet over de goederen beschikken, ze niet transformeren, vervreemden, doorgeven, graveren en/of onder welke titel dan ook aan een derde ter beschikking stellen. Dit eigendomsvoorbehoud geldt eveneens in geval van faillissement, reorganisatie of gerechtelijke liquidatie.
        ...
        },
        {
          ...
          text: `CV SERVICES voldoet aan de Belgische wetgeving uitgevaardigd door de Gewesten inzake afgedankte elektrische en elektronische apparatuur (AEEA). Om dit te doen, omvat de prijs van de producten en goederen niet de kosten voor het verzamelen en verwerken van afgedankte elektrische en elektronische apparatuur, die bovenop de prijs komt. De Klant wordt verzocht contact op te nemen met CV SERVICES om meer te weten te komen over de methoden voor het inzamelen en verwerken van zijn afgedankte elektrische en elektronische apparatuur.`
        },
        {
          title: "Artikel 9: Privacy",
          text: `9.1 CV SERVICES verwerkt persoonsgegevens voor het beheer van haar klantenbestand, voor de uitvoering van loyaliteitsprogramma's, evenals voor de promotie van haar producten, in overeenstemming met de wetgeving inzake gegevensbescherming en, meer specifiek, de Algemene Verordening Gegevensbescherming (AVG) en de wet van 30 juli 2018 betreffende de bescherming van natuurlijke personen in verband met de verwerking van persoonsgegevens. CV SERVICES is de verwerkingsverantwoordelijke in de zin van de AVG. De gegevens worden verwerkt hetzij op basis van de uitvoering van het contract tussen CV SERVICES en de Klant, hetzij op basis van zijn wettelijke verplichtingen, in het bijzonder op boekhoudkundig gebied. De gegevens worden verwerkt voor een periode die niet langer duurt dan nodig is om de bovengenoemde doeleinden te bereiken. In ieder geval worden ze verwijderd na een periode van 7 jaar vanaf het einde van de contractuele relatie.
          9.2 Zodra zijn persoonsgegevens worden verwerkt, beschikt de Klant over rechten: het recht op toegang tot de verwerkte gegevens en om deze indien nodig te corrigeren, het recht op beperking van de verwerking, het recht op verwijdering van gegevens en het recht op gegevensoverdraagbaarheid. Elk verzoek met betrekking tot de uitvoering van één of meer van deze rechten moet worden gericht aan CV SERVICES (hetzij per e-mail: info@cvservices.be; of per gewone post: CV SERVICES, Bergensesteenweg 458 te 1600 Sint-Pieters-Leeuw).
