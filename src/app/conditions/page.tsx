    ...
    fr: {
      ...
      cards: [
        ...
        },
        {
          ...
          3.9 Toute réclamation concernant une facture doit être envoyée au plus tard huit jours calendaires après réception, soit par e-mail : spl@solarstock.be ; soit par courrier recommandé : CV SERVICES, Bergensesteenweg 458 à 1600 Sint-Pieters-Leeuw.`
        },
        {
    ...
    nl: {
      ...
      cards: [
        ...
        },
        {
          ...
          3.9 Elke klacht met betrekking tot een factuur moet uiterlijk acht kalenderdagen na ontvangst worden verzonden, hetzij per e-mail: spl@solarstock.be; of per aangetekende post: CV SERVICES, Bergensesteenweg 458 te 1600 Sint-Pieters-Leeuw.`
        },
        {
